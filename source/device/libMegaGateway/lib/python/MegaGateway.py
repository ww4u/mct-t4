...
############################################################
    ...
    def mrgGetFirmWareHard(self, fd, name):
        buf = create_string_buffer(1024)
        ret = self._dll.mrgGetFirmWareHard(fd, name, buf)
        if ret < 0:
            return ""
        else:
            return cbuf_to_string(buf)
    ...
    def mrgGetFirmWareBoot(self, fd, name):
        buf = create_string_buffer(1024)
        ret = self._dll.mrgGetFirmWareBoot(fd, name, buf)
        if ret < 0:
            return ""
        else:
            return cbuf_to_string(buf)
    ...
    def mrgGetFirmWareFpga(self, fd, name):
        buf = create_string_buffer(1024)
        ret = self._dll.mrgGetFirmWareFpga(fd, name, buf)
        if ret < 0:
            return ""
        else:
            return cbuf_to_string(buf)
...
### int mrgSetRobotMachineSerialNum(ViSession vi, int name, char * sn);
    def mrgSetRobotMachineSerialNum(self, fd, roboname, arg):
        return self._dll.mrgSetRobotMachineSerialNum(fd, roboname, string_to_charp(arg))
...
### int mrgSetRobotSubType(ViSession vi, int name, int subtype);
    def mrgSetRobotSubType(self, fd, roboname, arg):
        return self._dll.mrgSetRobotSubType(fd, roboname, arg)
...
### int mrgSetRobotCoordinateSystem(ViSession vi, int name, int coord);
    def mrgSetRobotCoordinateSystem(self, fd, roboname, arg):
        return self._dll.mrgSetRobotCoordinateSystem(fd, roboname, arg)
...
### int mrgSetRobotWavetable(ViSession vi, int name, int wavetable);
    def mrgSetRobotWavetable(self, fd, roboname, arg):
        return self._dll.mrgSetRobotWavetable(fd, roboname, arg)
...
### int mrgRobotRun(ViSession vi, int name, int wavetable);
    def mrgRobotRun(self, fd, roboname, arg):
        return self._dll.mrgRobotRun(fd, roboname, arg)

### int mrgRobotStop(ViSession vi, int name, int wavetable);
    def mrgRobotStop(self, fd, roboname, arg):
        return self._dll.mrgRobotStop(fd, roboname, arg)

### int mrgRobotWaitReady(ViSession vi, int name, int wavetable, int timeout_ms);
    def mrgRobotWaitReady(self, fd, roboname, arg1, arg2):
        return self._dll.mrgRobotWaitReady(fd, roboname, arg1, arg2)

### int mrgRobotWaitEnd(ViSession vi, int name, int wavetable, int timeout_ms);
    def mrgRobotWaitEnd(self, fd, roboname, arg1, arg2):
        return self._dll.mrgRobotWaitEnd(fd, roboname, arg1, arg2)
...
### int mrgSetRobotInterPolateMode(ViSession vi, int name, int mode);
    def mrgSetRobotInterPolateMode(self, fd, roboname, arg):
        return self._dll.mrgSetRobotInterPolateMode(fd, roboname, arg)
...
### int mrgRobotWaitHomeEnd(ViSession vi, int name, int timeout_ms);
    def mrgRobotWaitHomeEnd(self, fd, roboname, arg):
        return self._dll.mrgRobotWaitHomeEnd(fd, roboname, arg)
...
### int mrgSetRobotHomeMode(ViSession vi, int name, int mode);
    def mrgSetRobotHomeMode(self, fd, roboname, arg):
        return self._dll.mrgSetRobotHomeMode(fd, roboname, arg)
...
### int mrgRobotPointResolve(ViSession vi, int name, int wavetable, int timeout_ms);
    def mrgRobotPointResolve(self, fd, roboname, arg1, arg2, arg3):
        return self._dll.mrgRobotPointResolve(fd, roboname, arg1, arg2, arg3)
...
### int mrgRobotPvtResolve(ViSession vi, int name, int wavetable, int timeout_ms);
    def mrgRobotPvtResolve(self, fd, roboname, arg1, arg2, arg3):
        return self._dll.mrgRobotPvtResolve(fd, roboname, arg1, arg2, arg3)

### int mrgRobotMotionFileImport(ViSession vi, int name,char* filename);
    def mrgRobotMotionFileImport(self, fd, roboname, arg):
        return self._dll.mrgRobotMotionFileImport(fd, roboname, string_to_charp(arg))
...
### int mrgRobotWaitToolExeEnd(ViSession vi, int name, int timeout_ms);
    def mrgRobotWaitToolExeEnd(self, fd, roboname, arg):
        return self._dll.mrgRobotWaitToolExeEnd(fd, roboname, arg)
...
### int mrgRobotToolGoHome(ViSession vi, int name, int timeout_ms);
    def mrgRobotToolGoHome(self, fd, roboname, arg):
        return self._dll.mrgRobotToolGoHome(fd, roboname, arg)
...
# int mrgGetMRQGroup(ViSession vi, char * devList, unsigned int * groupID, int grouptype);
    def mrgGetMRQGroup(self, fd, devListStr, arg, filename, grouptype):
        buf = create_string_buffer(1024)
        ret = self._dll.mrgGetMRQGroup(fd, string_to_charp(filename), buf, grouptype)
        if ret < 0:
            return ""
        else:
            return cbuf_to_string(buf)
...
# int mrgMRQMotionStateReport(ViSession vi, int name, int ch, int state);
    def mrgMRQMotionStateReport(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQMotionStateReport(fd, arg1, arg2, arg3)
...
# int mrgMRQMotionRun(ViSession vi, int name, int ch, int wavetable);
    def mrgMRQMotionRun(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQMotionRun(fd, arg1, arg2, arg3)
...
# int mrgMRQMotionWaitReady(ViSession vi, int name, int ch, int wavetable, int timeout_ms);
    def mrgMRQMotionWaitReady(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQMotionWaitReady(fd, arg1, arg2, arg3, arg4)

# int mrgMRQMotionWaitEnd(ViSession vi, int name, int ch, int wavetable, int timeout_ms);
    def mrgMRQMotionWaitEnd(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQMotionWaitEnd(fd, arg1, arg2, arg3, arg4)

# int mrgMRQMotionStop(ViSession vi, int name, int ch, int wavetable);
    def mrgMRQMotionStop(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQMotionStop(fd, arg1, arg2, arg3)

# int mrgMRQMotionTrigSource(ViSession vi, int name, int ch, int source);
    def mrgMRQMotionTrigSource(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQMotionTrigSource(fd, arg1, arg2, arg3)
...
# int mrgMRQMotionOffsetState(ViSession vi, int name, int ch, int state);
    def mrgMRQMotionOffsetState(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQMotionOffsetState(fd, arg1, arg2, arg3)
...
# int mrgMRQMotionABCount_Query(ViSession vi, int name, int ch);
    def mrgMRQMotionABCount_Query(self, fd, arg1, arg2):
        return self._dll.mrgMRQMotionABCount_Query(fd, arg1, arg2)

# int mrgMRQMotionABCountClear(ViSession vi, int name, int ch);
    def mrgMRQMotionABCountClear(self, fd, arg1, arg2):
        return self._dll.mrgMRQMotionABCountClear(fd, arg1, arg2)

# int mrgMRQMotionReverse(ViSession vi, int name, int state);
    def mrgMRQMotionReverse(self, fd, arg1, arg2):
        return self._dll.mrgMRQMotionReverse(fd, arg1, arg2)
...
# int mrgMRQAdjust(ViSession vi, int name, int ch, int wavetable,float position, float time, int timeout_ms);
    def mrgMRQAdjust(self, fd, arg1, arg2, arg3, arg4, agr5, arg6):
        return self._dll.mrgMRQAdjust(fd, arg1, arg2, arg3, c_float(arg4), c_float(agr5), arg6)
...
# int mrgMRQMotorStepAngle(ViSession vi, int name, int ch, int stepangle);
    def mrgMRQMotorStepAngle(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQMotorStepAngle(fd, arg1, arg2, arg3)
...
# int mrgMRQMotorMotionType(ViSession vi, int name, int ch, int type);
    def mrgMRQMotorMotionType(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQMotorMotionType(fd, arg1, arg2, arg3)
...
# int mrgMRQMotorPositionUnit(ViSession vi, int name, int ch, int unit);
    def mrgMRQMotorPositionUnit(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQMotorPositionUnit(fd, arg1, arg2, arg3)
...
# int mrgMRQMotorGearRatio(ViSession vi, int name, int ch, int a, int b);
    def mrgMRQMotorGearRatio(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQMotorGearRatio(fd, arg1, arg2, arg3, arg4)

# int mrgMRQMotorGearRatio_Query(ViSession vi, int name, int ch, int *a, int *b);
    def mrgMRQMotorGearRatio_Query(self, fd, dev, ch):
        a = c_int(-1)
        b = c_int(-1)
        ret = self._dll.mrgMRQMotorGearRatio_Query(fd, dev, ch, byref(a), byref(b) )
        if ret < 0:
            return list()
        else:
...
# int mrgMRQMotorLead(ViSession vi, int name, int ch, float millimeter);
    def mrgMRQMotorLead(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQMotorLead(fd, arg1, arg2, c_float(arg3))
...
# int mrgMRQMotorSize(ViSession vi, int name, int ch, int size);
    def mrgMRQMotorSize(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQMotorSize(fd, arg1, arg2, arg3)

# int mrgMRQMotorSize_Query(ViSession vi, int name, int ch, int *size);
    def mrgMRQMotorSize_Query(self, fd, dev, ch):
        result = c_int(-1)
        ret = self._dll.mrgMRQMotorSize_Query(fd, dev, ch, byref(result) )
        if ret < 0:
            return -1
        else:
            return result.value
...
# int mrgMRQMotorVoltate(ViSession vi, int name, int ch, int volt);
    def mrgMRQMotorVoltate(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQMotorVoltate(fd, arg1, arg2, arg3)

# int mrgMRQMotorVoltage_Query(ViSession vi, int name, int ch, int *volt);
    def mrgMRQMotorVoltage_Query(self, fd, dev, ch):
        result = c_int(-1)
        ret = self._dll.mrgMRQMotorVoltage_Query(fd, dev, ch, byref(result) )
        if ret < 0:
            return -1
        else:
            return result.value
...
# int mrgMRQMotorCurrent(ViSession vi, int name, int ch, float current);
    def mrgMRQMotorCurrent(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQMotorCurrent(fd, arg1, arg2, c_float(arg3))
...
# int mrgMRQMotorBackLash(ViSession vi, int name, int ch, float lash);
    def mrgMRQMotorBackLash(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQMotorBackLash(fd, arg1, arg2, c_float(arg3))
...
# int mrgMRQPVTConfig(ViSession vi, int name, int ch, int wavetable, int state);
    def mrgMRQPVTConfig(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQPVTConfig(fd, arg1, arg2, arg3, arg4)

# int mrgMRQPVTValue(ViSession vi, int name, int ch, int wavetable, float p, float v, float t);
    def mrgMRQPVTValue(self, fd, arg1, arg2, arg3, arg4,arg5, agr6):
        return self._dll.mrgMRQPVTValue(fd, arg1, arg2, arg3, c_float(arg4), c_float(arg5), c_float(agr6))

# int mrgMRQPVTState(ViSession vi, int name, int ch, int wavetable, int state);
    def mrgMRQPVTState(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQPVTState(fd, arg1, arg2, arg3, arg4)
...
# int mrgMRQPVTStateWait(ViSession vi, int name, int ch, int wavetable, int state, int timeout_ms);
    def mrgMRQPVTStateWait(self, fd, arg1, arg2, arg3, arg4, agr5):
        return self._dll.mrgMRQPVTStateWait(fd, arg1, arg2, arg3, arg4, agr5)

# int mrgMRQPVTTimeScale(ViSession vi, int name, int ch, int wavetable, int speedup, int speedcut);
    def mrgMRQPVTTimeScale(self, fd, arg1, arg2, arg3, arg4, arg5):
        return self._dll.mrgMRQPVTTimeScale(fd, arg1, arg2, arg3, arg4, arg5)
...
# int mrgMRQPVTCycle(ViSession vi, int name, int ch, int wavetable, unsigned int cycle);
    def mrgMRQPVTCycle(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQPVTCycle(fd, arg1, arg2, arg3, arg4)
...
# int mrgMRQPVTFifoBufferTime(ViSession vi, int name, int ch, int wavetable, unsigned int time);
    def mrgMRQPVTFifoBufferTime(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQPVTFifoBufferTime(fd, arg1, arg2, arg3, arg4)
...
# int mrgMRQPVTModeConfig(ViSession vi, int name, int ch,int wavetable, int exe, int plan, int motion);
    def mrgMRQPVTModeConfig(self, fd, arg1, arg2, arg3, arg4, arg5, agr6):
        return self._dll.mrgMRQPVTModeConfig(fd, arg1, arg2, arg3, arg4, arg5, agr6)

# int mrgMRQPVTModeExe(ViSession vi, int name, int ch, int wavetable, int mode);
    def mrgMRQPVTModeExe(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQPVTModeExe(fd, arg1, arg2, arg3, arg4)
...
# int mrgMRQPVTModePlan(ViSession vi, int name, int ch, int wavetable, int mode);
    def mrgMRQPVTModePlan(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQPVTModePlan(fd, arg1, arg2, arg3, arg4)
...
# int mrgMRQPVTModeMotion(ViSession vi, int name, int ch, int wavetable, int pattern);
    def mrgMRQPVTModeMotion(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQPVTModeMotion(fd, arg1, arg2, arg3, arg4)
...
# int mrgMRQPVTModifyDuty(ViSession vi, int name, int ch, int wavetable, int duty);
    def mrgMRQPVTModifyDuty(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQPVTModifyDuty(fd, arg1, arg2, arg3, arg4)
...
# int mrgMRQPVTEndState(ViSession vi, int name, int ch, int wavetable, int pattern);
    def mrgMRQPVTEndState(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQPVTEndState(fd, arg1, arg2, arg3, arg4)
...
# int mrgMRQPVTStopMode(ViSession vi, int name, int ch, int wavetable, int type);
    def mrgMRQPVTStopMode(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQPVTStopMode(fd, arg1, arg2, arg3, arg4)
...
# int mrgMRQPVTStopTime(ViSession vi, int name, int ch, int wavetable, float time);
    def mrgMRQPVTStopTime(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQPVTStopTime(fd, arg1, arg2, arg3, c_float(arg4))
...
# int mrgMRQPVTStopDistance(ViSession vi, int name, int ch, int wavetable, float distance);
    def mrgMRQPVTStopDistance(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQPVTStopDistance(fd, arg1, arg2, arg3, c_float(arg4))
...
# int mrgMRQPVTWavetableAddress(ViSession vi, int name, int ch, int wavetable, unsigned int address);
    def mrgMRQPVTWavetableAddress(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQPVTWavetableAddress(fd, arg1, arg2, arg3, arg4)
...
# int mrgMRQPVTWavetableSize(ViSession vi, int name, int ch, int wavetable, unsigned int size);
    def mrgMRQPVTWavetableSize(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQPVTWavetableSize(fd, arg1, arg2, arg3, arg4)
...
# int mrgMRQLostStepLineConfig(ViSession vi, int name, int ch, int wavetable, int state, float threshold, int resp);
    def mrgMRQLostStepLineConfig(self, fd, arg1, arg2, arg3, arg4, agr5, arg6):
        return self._dll.mrgMRQLostStepLineConfig(fd, arg1, arg2, arg3, arg4, c_float(agr5), arg6)

# int mrgMRQLostStepState(ViSession vi, int name, int ch, int wavetable, int state);
    def mrgMRQLostStepState(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQLostStepState(fd, arg1, arg2, arg3, arg4)
...
# int mrgMRQLostStepThreshold(ViSession vi, int name, int ch, int wavetable, float value);
    def mrgMRQLostStepThreshold(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQLostStepThreshold(fd, arg1, arg2, arg3, c_float(arg4))
...
# int mrgMRQLostStepResponse(ViSession vi, int name, int ch, int wavetable, int resp );
    def mrgMRQLostStepResponse(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQLostStepResponse(fd, arg1, arg2, arg3, arg4)
...
# int mrgMRQReportConfig(ViSession vi, int name, int ch, int funs, int state, float period);
    def mrgMRQReportConfig(self, fd, arg1, arg2, arg3, arg4, arg5):
        return self._dll.mrgMRQReportConfig(fd, arg1, arg2, arg3, arg4, c_float(arg5))

# int mrgMRQReportState(ViSession vi, int name, int ch, int funs, int state);
    def mrgMRQReportState(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQReportState(fd, arg1, arg2, arg3, arg4)
...
# int mrgMRQReportPeriod(ViSession vi, int name, int ch, int funs, int period);
    def mrgMRQReportPeriod(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQReportPeriod(fd, arg1, arg2, arg3, arg4)
...
# int mrgMRQTriggerMode(ViSession vi, int name, int ch, int mode);
    def mrgMRQTriggerMode(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQTriggerMode(fd, arg1, arg2, arg3)
...
# int mrgMRQTriggerLevelConfig(ViSession vi, int name, int ch, int trig, int state, int type, float period, int response);
    def mrgMRQTriggerLevelConfig(self, fd, arg1, arg2, arg3, arg4, arg5, agr6, agr7):
        return self._dll.mrgMRQTriggerLevelConfig(fd, arg1, arg2, arg3, arg4, arg5, c_float(agr6), agr7)

# int mrgMRQTriggerLevelState(ViSession vi, int name, int ch, int trig, int state);
    def mrgMRQTriggerLevelState(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQTriggerLevelState(fd, arg1, arg2, arg3, arg4)

# int mrgMRQTriggerLevelState_Query(ViSession vi, int name, int ch, int trig, int *state);
    def mrgMRQTriggerLevelState_Query(self, fd, dev, ch, arg):
        result = c_int(-1)
        ret = self._dll.mrgMRQTriggerLevelState_Query(fd, dev, ch, arg, byref(result) )
        if ret < 0:
            return -1
        else:
            return result.value
...
# int mrgMRQTriggerLevelType(ViSession vi, int name, int ch, int trig, int type);
    def mrgMRQTriggerLevelType(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQTriggerLevelType(fd, arg1, arg2, arg3, arg4)

# int mrgMRQTriggerLevelType_Query(ViSession vi, int name, int ch, int trig, int *type);
    def mrgMRQTriggerLevelType_Query(self, fd, dev, ch, arg):
        result = c_int(-1)
        ret = self._dll.mrgMRQTriggerLevelType_Query(fd, dev, ch, arg, byref(result) )
        if ret < 0:
            return -1
        else:
            return result.value
...
# int mrgMRQTriggerLevelResponse(ViSession vi, int name, int ch, int trig, int resp);
    def mrgMRQTriggerLevelResponse(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQTriggerLevelResponse(fd, arg1, arg2, arg3, arg4)

# int mrgMRQTriggerLevelResponse_Query(ViSession vi, int name, int ch, int trig,int *resp);
    def mrgMRQTriggerLevelResponse_Query(self, fd, dev, ch, arg):
        result = c_int(-1)
        ret = self._dll.mrgMRQTriggerLevelResponse_Query(fd, dev, ch, arg, byref(result) )
        if ret < 0:
            return -1
        else:
            return result.value
...
# int mrgMRQTriggerLevelPeriod(ViSession vi, int name, int ch, int trig, float period);
    def mrgMRQTriggerLevelPeriod(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQTriggerLevelPeriod(fd, arg1, arg2, arg3, c_float(arg4))


# int mrgMRQTriggerLevelPeriod_Query(ViSession vi, int name, int ch, int trig, float *period);
    def mrgMRQTriggerLevelPeriod_Query(self, fd, dev, ch, arg):
        result = c_int(-1)
        ret = self._dll.mrgMRQTriggerLevelPeriod_Query(fd, dev, ch, arg, byref(result) )
        if ret < 0:
            return -1
        else:
            return result.value
...
# int mrgMRQDriverConfig(ViSession vi, int name, int ch, int state, int microstep, float current);
    def mrgMRQDriverConfig(self, fd, arg1, arg2, arg3, arg4, arg5):
        return self._dll.mrgMRQDriverConfig(fd, arg1, arg2, arg3, arg4, c_float(arg5))
...
# int mrgMRQDriverCurrent(ViSession vi, int name, int ch, float current);
    def mrgMRQDriverCurrent(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQDriverCurrent(fd, arg1, arg2, c_float(arg3))
...
# int mrgMRQDriverIdleCurrent(ViSession vi, int name, int ch, float current);
    def mrgMRQDriverIdleCurrent(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQDriverIdleCurrent(fd, arg1, arg2, c_float(arg3))
...
# int mrgMRQDriverMicroStep(ViSession vi, int name, int ch, int microstep);
    def mrgMRQDriverMicroStep(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQDriverMicroStep(fd, arg1, arg2, arg3)
...
# int mrgMRQDriverState(ViSession vi, int name, int ch, int state);
    def mrgMRQDriverState(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQDriverState(fd, arg1, arg2, arg3)
...
# int mrgMRQDriverRegisterValue(ViSession vi, int name, int ch, int regIndex, unsigned int value);
    def mrgMRQDriverRegisterValue(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQDriverRegisterValue(fd, arg1, arg2, arg3, arg4)
...
# int mrgMRQDriverTuningState(ViSession vi, int name, int ch, int state);
    def mrgMRQDriverTuningState(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQDriverTuningState(fd, arg1, arg2, arg3)
...
# int mrgMRQDriverTuningMinCurrent(ViSession vi, int name, int ch, int ratio);
    def mrgMRQDriverTuningMinCurrent(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQDriverTuningMinCurrent(fd, arg1, arg2, arg3)
...
# int mrgMRQDriverTuningCurrentRegulate(ViSession vi, int name, int ch, int speedUp, int speedDown);
    def mrgMRQDriverTuningCurrentRegulate(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQDriverTuningCurrentRegulate(fd, arg1, arg2, arg3, arg4)
...
# int mrgMRQEncoderConfig(ViSession vi, int name, int ch,int state, int type, int linenum, int channelnum);
    def mrgMRQEncoderConfig(self, fd, arg1, arg2, arg3, arg4, arg5, arg6):
        return self._dll.mrgMRQEncoderConfig(fd, arg1, arg2, arg3, arg4, arg5, arg6)

# int mrgMRQEncoderLineNum(ViSession vi, int name, int ch, int num);
    def mrgMRQEncoderLineNum(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQEncoderLineNum(fd, arg1, arg2, arg3)
...
# int mrgMRQEncoderChannelNum(ViSession vi, int name, int ch, int channelnum);
    def mrgMRQEncoderChannelNum(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQEncoderChannelNum(fd, arg1, arg2, arg3)
...
# int mrgMRQEncoderType(ViSession vi, int name, int ch, int type);
    def mrgMRQEncoderType(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQEncoderType(fd, arg1, arg2, arg3)

# int mrgMRQEncoderType_Query(ViSession vi, int name, int ch, int *type);
    def mrgMRQEncoderType_Query(self, fd, dev, ch):
        result = c_int(-1)
        ret = self._dll.mrgMRQEncoderType_Query(fd, dev, ch, byref(result) )
        if ret < 0:
            return -1
        else:
            return result.value
...
# int mrgMRQEncoderMultiple(ViSession vi, int name, int ch, int multiple);
    def mrgMRQEncoderMultiple(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQEncoderMultiple(fd, arg1, arg2, arg3)
...
# int mrgMRQEncoderState(ViSession vi, int name, int ch, int state);
    def mrgMRQEncoderState(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQEncoderState(fd, arg1, arg2, arg3)
...
# int mrgMRQEncoderFeedback(ViSession vi, int name, int ch, int value);
    def mrgMRQEncoderFeedback(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQEncoderFeedback(fd, arg1, arg2, arg3)
...
# int mrgMRQEncoderDirection(ViSession vi, int name, int ch, int value);
    def mrgMRQEncoderDirection(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQEncoderDirection(fd, arg1, arg2, arg3)
...
# int mrgMRQAbsEncoderAlarmState(ViSession vi, int name, int ch, int state);
    def mrgMRQAbsEncoderAlarmState(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQAbsEncoderAlarmState(fd, arg1, arg2, arg3)
...
# int mrgMRQAbsEncoderAlarmUpLimit(ViSession vi, int name, int ch, int value);
    def mrgMRQAbsEncoderAlarmUpLimit(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQAbsEncoderAlarmUpLimit(fd, arg1, arg2, arg3)
...
# int mrgMRQAbsEncoderAlarmDownLimit(ViSession vi, int name, int ch, int value);
    def mrgMRQAbsEncoderAlarmDownLimit(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQAbsEncoderAlarmDownLimit(fd, arg1, arg2, arg3)
...
# int mrgMRQAbsEncoderAlarmResponse(ViSession vi, int name, int ch, int value);
    def mrgMRQAbsEncoderAlarmResponse(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQAbsEncoderAlarmResponse(fd, arg1, arg2, arg3)
...
# int mrgMRQAbsEncoderZeroValue(ViSession vi, int name, int ch, int value);
    def mrgMRQAbsEncoderZeroValue(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQAbsEncoderZeroValue(fd, arg1, arg2, arg3)
...
# int mrgMRQUartConfig(ViSession vi, int num, int name, int baud,char parity, int wordlen, int stopbit);    
    def mrgMRQUartConfig(self, fd, arg1, arg2, arg3, arg4, agr5, arg6):
        return self._dll.mrgMRQUartConfig(fd, arg1, arg2, arg3, arg4, agr5, arg6)
...
# int mrgMRQUartFlowctrl(ViSession vi, int num, int name, int mode);
    def mrgMRQUartFlowctrl(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQUartFlowctrl(fd, arg1, arg2, arg3)
...
# int mrgMRQUartSensorState(ViSession vi, int num, int num1, int name, int state);
    def mrgMRQUartSensorState(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQUartSensorState(fd, arg1, arg2, arg3, arg4)

# int mrgMRQUartSensorState_Query(ViSession vi, int num, int num1, int name, int *state);
    def mrgMRQUartSensorState_Query(self, fd, arg1, arg2, arg3):
        result = c_int(-1)
        ret = self._dll.mrgMRQUartSensorState_Query(fd, arg1, arg2, arg3, byref(result) )
        if ret < 0:
            return -1
        else:
            return result.value
...
# int mrgMRQUartSensorConfAll(ViSession vi, int num, int num1, int name, int sof, int framelen, int num2, int period);
    def mrgMRQUartSensorConfAll(self, fd, arg1, arg2, arg3, arg4, arg5, agr6, arg7):
        return self._dll.mrgMRQUartSensorConfAll(fd, arg1, arg2, arg3, arg4, arg5, agr6, arg7)
...
# int mrgMRQUartSensorConfSof(ViSession vi, int num, int num1, int name, int sof);
    def mrgMRQUartSensorConfSof(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQUartSensorConfSof(fd, arg1, arg2, arg3, arg4)

# int mrgMRQUartSensorConfSof_Query(ViSession vi, int num, int num1, int name, int *sof);
    def mrgMRQUartSensorConfSof_Query(self, fd, arg1, arg2, arg3):
        result = c_int(-1)
        ret = self._dll.mrgMRQUartSensorConfSof_Query(fd, arg1, arg2, arg3, byref(result) )
        if ret < 0:
            return -1
        else:
            return result.value
...
# int mrgMRQUartSensorConfFrameLen(ViSession vi, int num, int num1, int name, int len);
    def mrgMRQUartSensorConfFrameLen(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQUartSensorConfFrameLen(fd, arg1, arg2, arg3, arg4)

# int mrgMRQUartSensorConfFrameLen_Query(ViSession vi, int num, int num1, int name, int *len);
    def mrgMRQUartSensorConfFrameLen_Query(self, fd, arg1, arg2, arg3):
        result = c_int(-1)
        ret = self._dll.mrgMRQUartSensorConfFrameLen_Query(fd, arg1, arg2, arg3, byref(result) )
        if ret < 0:
            return -1
        else:
            return result.value
...
# int mrgMRQUartSensorConfRecvNum(ViSession vi, int num, int num1, int name, int num2);
    def mrgMRQUartSensorConfRecvNum(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQUartSensorConfRecvNum(fd, arg1, arg2, arg3, arg4)

# int mrgMRQUartSensorConfRecvNum_Query(ViSession vi, int num, int num1, int name, int *num2);
    def mrgMRQUartSensorConfRecvNum_Query(self, fd, arg1, arg2, arg3):
        result = c_int(-1)
        ret = self._dll.mrgMRQUartSensorConfRecvNum_Query(fd, arg1, arg2, arg3, byref(result) )
        if ret < 0:
            return -1
        else:
            return result.value
...
# int mrgMRQUartSensorConfPeriod(ViSession vi, int num, int num1, int name, int period);
    def mrgMRQUartSensorConfPeriod(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQUartSensorConfPeriod(fd, arg1, arg2, arg3, arg4)

# int mrgMRQUartSensorConfPeriod_Query(ViSession vi, int num, int num1, int name, int *period);
    def mrgMRQUartSensorConfPeriod_Query(self, fd, arg1, arg2, arg3):
        result = c_int(-1)
        ret = self._dll.mrgMRQUartSensorConfPeriod_Query(fd, arg1, arg2, arg3, byref(result) )
        if ret < 0:
            return -1
        else:
            return result.value
...
# int mrgMRQDistanceAlarmState(ViSession vi, int name, int ch, int state);
    def mrgMRQDistanceAlarmState(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQDistanceAlarmState(fd, arg1, arg2, arg3)

# int mrgMRQDistanceAlarm(ViSession vi, int name, int num, int ch, float distance);
    def mrgMRQDistanceAlarm(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgMRQDistanceAlarm(fd, arg1, arg2, arg3, c_float(arg4))
...
# int mrgMRQNewDriverType_Query(ViSession vi, int name, int ch, char *type);
    def mrgMRQNewDriverType_Query(self, fd, name, ch):
        buf = create_string_buffer(1024)
        ret = self._dll.mrgMRQNewDriverType_Query(fd, name, ch, buf)
        if ret < 0:
            return ""
        else:
            return cbuf_to_string(buf)
...
# int mrgMRQNewDriverCurrent(ViSession vi, int name, float current);
    def mrgMRQNewDriverCurrent(self, fd, arg1, arg2):
        return self._dll.mrgMRQNewDriverCurrent(fd, arg1, c_float(arg2))
...
# int mrgMRQNewDriverMicrosteps(ViSession vi, int name, int microstep);
    def mrgMRQNewDriverMicrosteps(self, fd, arg1, arg2):
        return self._dll.mrgMRQNewDriverMicrosteps(fd, arg1, arg2)
...
# int mrgMRQNewDriverState(ViSession vi, int name, int ch, int state);
    def mrgMRQNewDriverState(self, fd, arg1, arg2, arg3):
        return self._dll.mrgMRQNewDriverState(fd, arg1, arg2, arg3)
...
### int mrgSysConfCan(ViSession vi, int baud);
    def mrgSysConfCan(self, fd, arg):
        return self._dll.mrgSysConfCan(fd, arg)

### int mrgSysModeSwitch(ViSession vi, int mode);
    def mrgSysModeSwitch(self, fd, arg):
        return self._dll.mrgSysModeSwitch(fd, arg)
...
### int mrgSysWifiUpDown(ViSession vi, int state);
    def mrgSysWifiUpDown(self, fd, arg):
        return self._dll.mrgSysWifiUpDown(fd, arg)

### int mrgSysWifiCheckState(ViSession vi, int timeout_ms);
    def mrgSysWifiCheckState(self, fd, arg):
        return self._dll.mrgSysWifiCheckState(fd, arg)
...
### int mrgSysSetHeartPeriod(ViSession vi, int value);
    def mrgSysSetHeartPeriod(self, fd, arg):
        return self._dll.mrgSysSetHeartPeriod(fd, arg)
...
### int mrgSysSetPowerOn(ViSession vi, int value);
    def mrgSysSetPowerOn(self, fd, arg):
        return self._dll.mrgSysSetPowerOn(fd, arg)
...
### int mrgSysSetInterface(ViSession vi, int face);
    def mrgSysSetInterface(self, fd, arg):
        return self._dll.mrgSysSetInterface(fd, arg)
...
### int mrgSysSetEmergencyStop(ViSession vi, int state);
    def mrgSysSetEmergencyStop(self, fd, arg):
        return self._dll.mrgSysSetEmergencyStop(fd, arg)
...
### int CALL mrgErrorCodeConfigDownload(ViSession vi, int code, int type, int response, int diagnose, int enable);
    def mrgErrorCodeConfigDownload(self, fd, arg1, arg2, arg3, arg4):
        return self._dll.mrgErrorCodeConfigDownload(fd, arg1, arg2, arg3, arg4)
...
### int mrgSetProjectMode(ViSession vi, int state);
    def mrgSetProjectMode(self, fd, arg):
        return self._dll.mrgSetProjectMode(fd, arg)
...
### int mrgProjectSetYout(ViSession vi, int index, int state);
    def mrgProjectSetYout(self, fd, arg1, arg2):
        return self._dll.mrgProjectSetYout(fd, arg1, arg2)
