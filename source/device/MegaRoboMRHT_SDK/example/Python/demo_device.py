...
###############################################################################
    ...
    ret = gw.mrgWriteDeviceSerial(visa, deviceID, "MRQMXX111122223333")
    print("mrgWriteDeviceSerial change test", ret)
    print( "device deviceSerialNumber:", gw.mrgGetDeviceSerialNumber(visa, deviceID) )

    ret = gw.mrgWriteDeviceSerial(visa, deviceID, deviceSerialNumber)
    print("mrgWriteDeviceSerial restore", ret)
    print( "device deviceSerialNumber:", gw.mrgGetDeviceSerialNumber(visa, deviceID) )
    ...
    # ret = gw.mrgModeSwitch(visa, 0)
    # print("mrgModeSwitch 0", ret)
    # time.sleep(2)
    # ret = gw.mrgModeSwitch(visa, 1)
    # print("mrgModeSwitch 1", ret)
